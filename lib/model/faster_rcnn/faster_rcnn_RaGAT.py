...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        pooled_feat = self._head_to_tail(pooled_feat.view(
            batch_size,-1, pooled_feat.size(1), pooled_feat.size(2), pooled_feat.size(3)),
            rois[:,:,1:])
        pooled_feat = pooled_feat.view(-1, pooled_feat.size(2))# [bs*256, 1024]
