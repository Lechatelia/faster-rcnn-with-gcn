...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        # roi_pos = RoIPositionEmbedding()
        pooled_feat, loss_gl = self._head_to_tail(pooled_feat,batch_size) # [bs*256, 4096]
        ...
        return rois, cls_prob, bbox_pred, rpn_loss_cls, rpn_loss_bbox, RCNN_loss_cls, RCNN_loss_bbox, rois_label, loss_gl
