...
def parse_args():
  ...
  parser.add_argument('--image_dir', dest='image_dir',
                      ...
                      default="images")
  parser.add_argument('--image_savedir', dest='image_savedir',
                      help='directory to load images for demo',
                      default="output")
...
if __name__ == '__main__':
  ...
  if webcam_num >= 0 :
    ...
    # imglist = [ i, if i[4] != '_', for i in imglist]
  ...
  while (num_images >= 0):
      ...
      if vis and webcam_num == -1:
          ...
          # cv2.waitKey(0)
          result_path = os.path.join(args.image_savedir, imglist[num_images][:-4] + "_det_test.jpg")
